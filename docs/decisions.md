...
The website depends on a `config.py` file to read in the Firebase API key and auth URL.  These values should not be stored in the repo, because every new instance will have distinct values.  Our options were: 
