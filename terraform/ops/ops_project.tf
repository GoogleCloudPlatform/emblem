data "google_project" "emblem_project" {
  project_id = var.google_project_id
}

provider "google" {
  alias   = "ops"
  project = data.google_project.emblem_project.project_id
...
## Give the Cloud Run service account access to AR repos
/*
resource "google_artifact_registry_repository_iam_member" "iam_api_ar" {
  provider   = google-beta
  location   = var.google_region
  repository = google_artifact_registry_repository.ops_api_docker.name
  role       = "roles/artifactregistry.reader"
  member     = "serviceAccount:service-${data.google_project.emblem_project.number}@serverless-robot-prod.iam.gserviceaccount.com"
...
resource "google_project_iam_member" "ops_ar_admin_iam" {
  ...
  member     = "serviceAccount:${data.google_project.emblem_project.number}@cloudbuild.gserviceaccount.com"
