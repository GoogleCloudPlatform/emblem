...
def init(app):
    ...
    def check_user_authentication():
        ...
        if expiration is not None and expiration - datetime.timestamp(datetime.now()) < 30:    # seconds
            ...
            if refresh_token is not None:
                ...
                session["expiration"] = datetime.timestamp(datetime.now()) + updates["expires_in"]
                print(f"DEBUG - set the new session values. Let's see if they get to the browser.")
